...
from .views import (
    ...
    CustomerSelectView, QuotationDetailView,
)
...
urlpatterns = [
    ...
    path('quotations/<int:pk>/pdf/', views.generate_quotation_pdf, name='quotation_pdf'),
    ...
    path('custom-items/<int:pk>/update/', CustomItemUpdateView.as_view(), name='custom_item_update'),
    path('custom-items/<int:pk>/delete/', CustomItemDeleteView.as_view(), name='custom_item_delete'),
