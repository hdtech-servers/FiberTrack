"""
Django settings for FiberTrack project.
...
SECRET_KEY = 'django-insecure-+mj#g8cfwg4ubm#9d11j2q07rczc&t)ex2od#ahvv-*c8&t0z9'
...
# Additional locations of static files (where you store static files in development)
STATICFILES_DIRS = [
